...
{
	t_pin_sortie_destroy(sortie->pin); //va liberer la mémoire occupée par la fonction "sortie"
	free(sortie->nom);//libère le bloc de memoire alloue dynamiquement pour le nom de la sortie
